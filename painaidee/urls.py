...
urlpatterns = [
    ...
    path('อุทยานหินเขางู',views.c6,name='c6'),
    path('นครนายก ตอนที่ 1',views.c7,name='c7'),
    path('นครนายก ตอนที่ 2',views.c8,name='c8'),
    path('นครนายก ตอนที่ 3',views.c9,name='c9'),
    path('นครนายก ตอนที่ 4',views.c10,name='c10'),
    path('นครนายก ตอนที่ 5',views.c11,name='c11'),
    path('น้ำตกเอราวัญ',views.c12,name='c12'),

    path('ภาคเหนือ',views.north,name='north'),
    path('เสาดินนาน้อย',views.n1,name='n1'),
    path('ดอยแม่อูคอ',views.n2,name='n2'),
