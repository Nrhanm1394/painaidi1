...
def n1 (request):
    return render(request,'frontend/north/n1.html')
def n2 (request):
    return render(request,'frontend/north/n2.html')
def n3 (request):
...
def c6 (request):
    return render(request,'frontend/central/c6.html')
def c7 (request):
    return render(request,'frontend/central/c7.html')
def c8 (request):
    return render(request,'frontend/central/c8.html')
def c9 (request):
    return render(request,'frontend/central/c9.html')
def c10 (request):
    return render(request,'frontend/central/c10.html')
def c11 (request):
